...
Java_com_android_study_MainActivity_copyString(JNIEnv* env, jobject thiz, jstring src) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_android_study_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
JNIEXPORT void JNICALL native_callTestttttttttttt(JNIEnv *env, jobject clazz, jstring str) {
    ...
    jclass mainActivityClass = env->FindClass("com/android/study/MainActivity");
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *) {
    ...
    jclass clazz = env->FindClass("com/android/study/MainActivity");
    if (clazz == nullptr) {
        return JNI_ERR;
    }
...
//Java_com_android_study_MainActivity_callTestttttttttttt(JNIEnv *env, jobject thiz, jstring str) {
