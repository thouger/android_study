package com.android.study.hunter;
...
import com.android.study.lang3.ClassUtils;
import com.android.study.lang3.reflect.MemberUtils;
...
public final class XposedHelpers {
    ...
    public static int incrementMethodDepth(String method) {
        return Objects.requireNonNull(getMethodDepthCounter(method).get()).incrementAndGet();
    }
    ...
    public static int decrementMethodDepth(String method) {
        return Objects.requireNonNull(getMethodDepthCounter(method).get()).decrementAndGet();
    }
    ...
    public static int getMethodDepth(String method) {
        return Objects.requireNonNull(getMethodDepthCounter(method).get()).get();
    }
